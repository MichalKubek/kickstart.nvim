...
require('which-key').add({
  {'<leader>c', desc = '[C]ode', group = "code"},
  {'<leader>g', desc = '[G]it',  group = "git"},
  {'<leader>h', desc = 'Git [H]unk', group = "hunk"},
  {'<leader>r', desc = '[R]ename', group = "rename"},
  {'<leader>s', desc = '[S]earch', group = "search"},
  {'<leader>t', desc = '[T]oggle', group = "toggle"},
  {'<leader>w', desc = '[W]orkspace', group = "workspace"},
}
)
