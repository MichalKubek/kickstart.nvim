...
vim.g.python_flake8_options = '~/.config/nvim/setup.cfg'  -- Specify the path to your flake8 configuration file

vim.g.yapf_options = '--style="{based_on_style: pep8, column_limit: 120}"'
vim.g.black_line_length = 120
vim.g.python_flake8_options = '--max-line-length=120'
